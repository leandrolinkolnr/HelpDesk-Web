...
public abstract class Pessoa implements Serializable {
    ...
    public Pessoa() {
        ...
        // Se criar uma pessoa sem parametros, recebe o perfil de cliente
    ...
    public Pessoa(Integer id, String nome, String cpf, String email, String senha) {
        ...
        this.email = email;
        this.senha = senha;
        addPerfil(Perfil.CLIENTE); // pq?
    }

    // Poderiamos usar o lombok e gerar tudo
    ...
    public Set<Perfil> getPerfis() {
        // o toEnum vai retornar cada um dos perfis, vai transformar em set e vai retornar
        return perfis.stream().map(x -> Perfil.toEnum(x)).collect(Collectors.toSet());
    }


    public void addPerfil(Perfil perfil) {
        // é uma coleção de indices dos perfis, e nao do perfil em si
